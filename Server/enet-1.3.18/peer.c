...
*/
void
enet_peer_throttle_configure (ENetPeer * peer, const enet_uint32 interval, const enet_uint32 acceleration, const enet_uint32 deceleration)
{
...
int
enet_peer_throttle (ENetPeer * peer, const enet_uint32 rtt)
{
...
*/
int
enet_peer_send (ENetPeer * peer, const enet_uint8 channelID, ENetPacket * packet)
{
   ENetChannel * channel;
   ENetProtocol command;
...
static void
enet_peer_remove_incoming_commands (ENetList * queue, const ENetListIterator startCommand, const ENetListIterator endCommand, ENetIncomingCommand * excludeCommand)
{
...
*/
void
enet_peer_ping_interval (ENetPeer * peer, const enet_uint32 pingInterval)
{
...
void
enet_peer_timeout (ENetPeer * peer, const enet_uint32 timeoutLimit, const enet_uint32 timeoutMinimum, const enet_uint32 timeoutMaximum)
{
...
*/
void
enet_peer_disconnect_now (ENetPeer * peer, const enet_uint32 data)
{
    ENetProtocol command;
...
*/
void
enet_peer_disconnect (ENetPeer * peer, const enet_uint32 data)
{
    ENetProtocol command;
...
*/
void
enet_peer_disconnect_later (ENetPeer * peer, const enet_uint32 data)
{   
    if ((peer -> state == ENET_PEER_STATE_CONNECTED || peer -> state == ENET_PEER_STATE_DISCONNECT_LATER) && 
...
ENetAcknowledgement *
enet_peer_queue_acknowledgement (ENetPeer * peer, const ENetProtocol * command, const enet_uint16 sentTime)
{
    ENetAcknowledgement * acknowledgement;

    if (command -> header.channelID < peer -> channelCount)
    {
        const ENetChannel * channel = & peer -> channels [command -> header.channelID];
...
ENetOutgoingCommand *
enet_peer_queue_outgoing_command (ENetPeer * peer, const ENetProtocol * command, ENetPacket * packet, const enet_uint32 offset, const enet_uint16 length)
{
...
enet_peer_dispatch_incoming_unreliable_commands (ENetPeer * peer, ENetChannel * channel, ENetIncomingCommand * queuedCommand)
{
    ...
    for (droppedCommand = startCommand = currentCommand = enet_list_begin (& channel -> incomingUnreliableCommands);
         ...
         currentCommand = enet_list_next (currentCommand))
    {
       const ENetIncomingCommand * incomingCommand = (ENetIncomingCommand *) currentCommand;
...
ENetIncomingCommand *
enet_peer_queue_incoming_command (ENetPeer * peer, const ENetProtocol * command, const void * data, const size_t dataLength, const enet_uint32 flags, const enet_uint32 fragmentCount)
{
